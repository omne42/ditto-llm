...
require_file "$root/docs/src/index.md"
require_file "$root/docs/src/SUMMARY.md"
...
require_contains "$root/docs/README.md" "docs/architecture/system-boundaries.md"
require_contains "$root/docs/README.md" "docs/architecture/source-layout.md"
require_contains "$root/docs/README.md" "docs/src/index.md"
require_contains "$root/docs/README.md" "docs/src/SUMMARY.md"
require_contains "$root/docs/docs-system-map.md" "README.md"
require_contains "$root/docs/docs-system-map.md" "AGENTS.md"
require_contains "$root/docs/docs-system-map.md" "docs/architecture/system-boundaries.md"
require_contains "$root/docs/docs-system-map.md" "docs/architecture/source-layout.md"
require_contains "$root/docs/docs-system-map.md" "docs/src/"
