...
- Agent: built-in tool wrappers and executors (`http_fetch`, `fs_read_file`, `fs_write_file`, `fs_list_dir`, `fs_find`, `fs_stat`, `shell_exec`) for `ToolLoopAgent` (feature `agent`).
