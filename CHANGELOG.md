...
- Gateway: stop exposing `ditto_server::gateway::{adapters,application,domain,transport,translation}` as stable public module paths; keep the supported northbound surface on `ditto_server::gateway::*` root facades and compatibility shims instead.
