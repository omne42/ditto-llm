...
pub fn invocation_operations_for_capability(
    ...
    match capability {
        CapabilityKind::LLM => Some(LLM_INVOCATION_OPERATIONS),
        CapabilityKind::EMBEDDING => Some(EMBEDDING_INVOCATION_OPERATIONS),
        CapabilityKind::IMAGE_GENERATION => Some(IMAGE_GENERATION_INVOCATION_OPERATIONS),
        CapabilityKind::IMAGE_EDIT => Some(IMAGE_EDIT_INVOCATION_OPERATIONS),
        CapabilityKind::VIDEO_GENERATION => Some(VIDEO_GENERATION_INVOCATION_OPERATIONS),
        CapabilityKind::AUDIO_SPEECH => Some(AUDIO_SPEECH_INVOCATION_OPERATIONS),
        CapabilityKind::AUDIO_TRANSCRIPTION => Some(AUDIO_TRANSCRIPTION_INVOCATION_OPERATIONS),
        CapabilityKind::REALTIME => Some(REALTIME_INVOCATION_OPERATIONS),
        CapabilityKind::RERANK => Some(RERANK_INVOCATION_OPERATIONS),
        CapabilityKind::MODERATION => Some(MODERATION_INVOCATION_OPERATIONS),
        CapabilityKind::BATCH => Some(BATCH_INVOCATION_OPERATIONS),
        _ => None,
    }
}
...
mod tests {
    ...
    fn named_operations_map_to_expected_capabilities() {
        for (operation, capability) in [
            (OperationKind::CHAT_COMPLETION, CapabilityKind::LLM),
            (OperationKind::RESPONSE, CapabilityKind::LLM),
            (OperationKind::TEXT_COMPLETION, CapabilityKind::LLM),
            (OperationKind::EMBEDDING, CapabilityKind::EMBEDDING),
            (
            ...
            (
                OperationKind::IMAGE_TRANSLATION,
                CapabilityKind::IMAGE_TRANSLATION,
            ),
            (
                OperationKind::IMAGE_QUESTION,
            ...
            (
                OperationKind::AUDIO_TRANSLATION,
                CapabilityKind::AUDIO_TRANSLATION,
            ),
            (
                OperationKind::AUDIO_VOICE_CLONE,
                CapabilityKind::AUDIO_VOICE_CLONE,
            ),
            (
                OperationKind::AUDIO_VOICE_DESIGN,
                CapabilityKind::AUDIO_VOICE_DESIGN,
            ),
            ...
            (OperationKind::THREAD_RUN, CapabilityKind::LLM),
            (OperationKind::GROUP_CHAT_COMPLETION, CapabilityKind::LLM),
            ...
            (
                OperationKind::THREE_D_GENERATION,
