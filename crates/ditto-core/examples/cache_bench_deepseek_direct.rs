...
use ditto_core::contracts::Usage;
use ditto_core::contracts::{ContentPart, GenerateRequest, Message, StreamChunk};
use ditto_core::llm_core::model::LanguageModel;
use ditto_core::provider_options::ProviderOptions;
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    for round in 1..=5 {
        ...
        req = ditto_core::provider_options::request_with_provider_options(
            req,
            ProviderOptions {
