...
#[allow(dead_code)]
pub(super) struct ProxyFailureContext<'a> {
    ...
    pub(super) attempted_backends: &'a [String],
    pub(super) body_len: usize,
    pub(super) charge_tokens: u32,
    pub(super) charge_cost_usd_micros: Option<u64>,
    pub(super) last_err: Option<(StatusCode, Json<OpenAiErrorResponse>)>,
    pub(super) metrics: Option<(&'a str, std::time::Instant)>,
}

pub(super) async fn finalize_openai_compat_proxy_failure(
