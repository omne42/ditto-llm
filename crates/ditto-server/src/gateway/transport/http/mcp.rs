...
pub(super) async fn handle_mcp_root(
...
pub(super) async fn handle_mcp_subpath(
    State(state): State<GatewayHttpState>,
...
pub(super) async fn handle_mcp_namespaced_root(
    State(state): State<GatewayHttpState>,
...
pub(super) async fn handle_mcp_namespaced_subpath(
    State(state): State<GatewayHttpState>,
...
pub(super) async fn mcp_list_tools(
    state: &GatewayHttpState,
    server_ids: &[String],
    cursor: Option<String>,
